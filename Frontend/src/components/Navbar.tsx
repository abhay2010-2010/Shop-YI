                ...
                <div className="flex space-x-4">
                    ...
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-gray-700">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.023.835l.938 6.878a.86.86 0 00.954.678h10.366c.49 0 .907-.37.957-.864l.983-8.855A1.157 1.157 0 0021.75 3H2.25zM12 20.25a.75.75 0 100-1.5.75.75 0 000 1.5zM19.5 20.25a.75.75 0 100-1.5.75.75 0 000 1.5z" />
                        </svg>
